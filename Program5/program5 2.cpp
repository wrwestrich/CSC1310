		...
		switch(choice)
		{
			...
			case 2:
				...
				if(isMember(myArray, ARRAY_SIZE, num))
                    cout << endl << endl << num << " is in the array." << endl;
                else
                    cout << endl << endl << num << " is not in the array." << endl;
			...
			case 4:
				...
				if(isPalindrome(userStrWithoutSpaces))
                    cout << endl << userString << " is a palindrome." << endl;
                else
			...
			case 5:
				...
				cout << endl << num1 << " x " << num2 << " = " << multiply(num1, num2) << endl;
				break;
